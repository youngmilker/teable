...
export const GanttConfig: FC<PropsWithChildren> = (props) => {
  ...
  const dateSelects = [
    {
      label: t('table:gantt.toolbar.startDateField'),
      key: 'startDateFieldId',
      value: startDateField?.id,
    },
    {
      label: t('table:gantt.toolbar.endDateField'),
      key: 'endDateFieldId',
  ...
  const colorTypeSelects = [
    { label: t('table:gantt.toolbar.customColor'), value: ColorConfigType.Custom },
    { label: t('table:gantt.toolbar.alignWithRecords'), value: ColorConfigType.Field },
  ];
          ...
          <Fragment>
            ...
            <div className="flex flex-col gap-2">
              <span className="text-xs text-muted-foreground">
                {t('table:gantt.toolbar.titleField')}
              </span>
              <Select
            ...
            <div className="flex flex-col gap-2">
              <span className="text-xs text-muted-foreground">
                {t('table:gantt.toolbar.colorType')}
              </span>
              <Select
                value={colorType}
            ...
            {colorType === ColorConfigType.Field && (
              <div className="flex flex-col gap-2">
                <span className="text-xs text-muted-foreground">
                  {t('table:gantt.toolbar.colorField')}
                </span>
                <Select
                ...
                >
                  <SelectTrigger className="bg-background">
                    <SelectValue placeholder={t('table:gantt.placeholder.selectColorField')} />
                  </SelectTrigger>
                  <SelectContent className="w-full">
