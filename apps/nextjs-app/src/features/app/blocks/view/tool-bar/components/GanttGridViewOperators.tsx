...
import { GanttConfig } from '../../gantt/components';
import { useToolbarChange } from '../../hooks/useToolbarChange';
import { ToolBarButton } from '../ToolBarButton';
import { useToolBarStore } from './useToolBarStore';

export const GanttGridViewOperators: React.FC<{ disabled?: boolean }> = (props) => {
    ...
    <div className="flex min-w-0 flex-1 gap-1">
      <GanttConfig>
        <ToolBarButton
          disabled={disabled}
          isActive={false}
          text={t('table:gantt.toolbar.config')}
      ...
      <RowHeight
        ...
        fieldNameDisplayLinesRange={{ min: 2, max: 4 }}
        onChange={(type, value) => {
